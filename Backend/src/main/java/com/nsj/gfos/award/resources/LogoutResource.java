...
public class LogoutResource {
	...
	/**
	 * Die Methode <i>logoutPost</i> wird bei einer POST Anfrage an diese Resource
	 * aufgerufen und verarbeitet die als Parameter gegebene SessionID und gibt
	 * diese an den <i>SessionHandler</i> weiter.
	 * 
	 * @param sessionID - Teil der URL nach 'logout' also zum Beispiel
	 *                  'auth=123456789012'also icg
	 * @return String - Fehler bei falscher Formatierung des Parameters oder die
	 *         Rückgabe von <i>SessionHandler.closeSession(...)</i>
	 */
	@POST
