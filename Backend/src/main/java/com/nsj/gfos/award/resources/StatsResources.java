...
public class StatsResources {
	...
	public String getMitarbeiterCount() {
		...
		try {
			...
			if(!rs.next())
				return JsonHandler.fehler("Es ist ein Fehler in der Datenbankl aufgetreten");
		} catch (SQLException e) {JsonHandler.fehler("Es ist ein Fehler in der Datenbankl aufgetreten");}
	}
